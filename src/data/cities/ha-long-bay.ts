...
export const haLongBay: CityContent = {
  ...
  places: [
    ...
    {
      id: "cua-van-floating-village",
      cityId: "ha-long-bay",
      category: "attraction",
      name: "הכפר הצף קואה ואן",
    ...
    {
      id: "luon-cave-kayaking",
      cityId: "ha-long-bay",
      category: "special",
      name: "קיאקים במערת לואון",
      nameLatin: "Luon Cave",
      description:
  ...
  warnings: [
    {
      id: "typhoon-season-storms",
      cityId: "ha-long-bay",
      text: "ספטמבר הוא חלק מעונת הטייפונים בצפון וייטנאם (יולי-ספטמבר), וביולי 2025 התהפכה בסערה פתאומית ספינת תיירים במפרץ ונהרגו כ-39 נוסעים. יש לבחור מפעיל שיט מורשה ומוכר, וללבוש אפוד הצלה בכל פעילות על המים כשהצוות מנחה.",
    },
    {
      id: "kayak-currents-safety",
      cityId: "ha-long-bay",
      text: "זרמים וגלי סירות בכניסות למערות כמו מערת לואון עלולים להפתיע מי שלא רגיל לקיאק. יש להישאר קרוב למדריך, לא להתרחק מגבולות השייט המוגדרים, וללבוש אפוד הצלה תמיד - גם מבוגרים שיודעים לשחות.",
    },
    {
      id: "cave-island-steps",
      cityId: "ha-long-bay",
      text: "הגישה לתצפית באי טי טופ כוללת כ-400 מדרגות תלולות, וגם במערות כמו סונג סוט יש מאות מדרגות אבן חשופות לשמש. מומלץ נעליים סגורות ונוחות, בקבוק מים, וקצב הליכה מותאם לילדים בחום ובלחות הגבוהים של האזור.",
    },
    {
      id: "seasickness-medication",
      cityId: "ha-long-bay",
      text: "בספטמבר הים יכול להיות סוער יותר מבעונת החורף השקטה, גם בלי סערה של ממש. כדאי להחזיק כדורים למחלת ים עבור ילדים ומבוגרים רגישים לתנועה, ולבקש תא קרוב למרכז הספינה שבו התנודה מורגשת פחות.",
    },
  ],
  phrases: [],
};
